...
public class OneToManyWithoutAttributesAggregationUnidirectional extends UsageTest {
    ...
    @Test
    public void testUpdateAntonio() throws Exception {
        ...
        final Set<B> news = new HashSet<B>();
        ...
        execute(new Transaction<A>() {
            ...
            public A run(Session session) {
                ...
                assertEquals(3, bs.size());
                {
                    ...
                    while (it.hasNext()) {
                        B b = it.next();
                        if (b.id == 1 && b.name.equals("b1")) {
                            found1 = true;
                        } else if (b.id == 2 && b.name.equals("b2 name changed")) {
                            found2 = true;
                        } else if (b.id == 3 && b.name.equals("b3")) {
                            found3 = true;
                        } else {
