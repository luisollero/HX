...
public class ManyToManyWithAttributesUnidirectional extends UsageTest {
    ...
    public void testSave2() throws Exception {
        ...
        execute(new Transaction<A>() {
            ...
            public A run(Session session) {
                ...
                assertEquals(1, session.createCriteria(AB.class).list().size());
                assertEquals(1, ((A) session.get(A.class, 1)).abs.size());
    ...
    public void testUpdate() throws Exception {
        ...
        final A readA2 = execute(new Transaction<A>() {
        ...
        assertEquals(1, readA2.abs.size());
        readA2.abs.clear();
